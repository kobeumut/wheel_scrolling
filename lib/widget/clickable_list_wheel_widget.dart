import 'package:wheel_scrolling/measure_size.dart';
import 'package:wheel_scrolling/widget/wheel_scrolling_view.dart'
    as CWSV;
...
class _ClickableListWheelScrollViewState
  ...
  double _getClickedOffset() {
    ...
    return _tapUpDetails!.dx - (_listHeight! / 2.0);
  }
